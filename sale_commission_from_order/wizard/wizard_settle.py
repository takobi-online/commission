    ...
    def action_settle(self):
        ...
        for agent in order_based_agents:
            ...
            for agent_line in agent_lines:
                ...
                # Force _compute_settled because there is not direct dependency that
                # triggers it
                # And we need to skip invoice base settlement if already settled
                # by order
                agent_line.object_id.mapped("invoice_lines.agents")._compute_settled()
